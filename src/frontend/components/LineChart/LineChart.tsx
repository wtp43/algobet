...
//
//   // data for lines
//   const data1 = data.filter((el: any) => el.type === 'RENEWABLE');
//
//   const data2 = data.filter((el: any) => el.type === 'TOTAL');
//
...
//   const getRD = (d: any) => d.amount;
//   const getDate = (d: any) => d.year;
//   const bisectDate = bisector((d: any) => d.year).left;
//
//   // get data from a year
//   const getD = (year: any) => {
//     const output = data.filter((el: any) => el.year === year);
//     return output;
//   };
//
//   // to remove comma from date
//   const formatDate = (year: any) => year.toString();
//
//   // Defining scales
//   // horizontal, x scale
...
//   };
//
//   const handleTooltip = useCallback((event: any) => {
